...
public class brailletableActivity extends BaseActivity {
    ...
    ImageView consonant_initial_one, consonant_initial_two, finalconsonant_initial_one,finalconsonant_initial_two,
            vowel_one, vowel_two,vowel_three,number_one,number_two, conjunction_one, conjunction_two, abbreviation_one,
            abbreviation_two, abbreviation_three, alphabet_one, alphabet_two, alphabet_three, alphabet_four;
    TextView viewmenu;
